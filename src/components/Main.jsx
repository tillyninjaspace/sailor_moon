                ...
                <h2>TV "manga"</h2>
            {
              sailorMoonItems.data && sailorMoonItems.data.filter((item) => {    
                ...
                <div className="scroll" key={tv.mal_id}>
                    ...
                    <img src={tv.images.jpg.image_url}/>{tv.title}</NavLink>
                </div>
              ) || 
              <Spinner animation="grow" />
            } 
