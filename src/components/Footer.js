    ...
    return (
        <div style ={{border: '1px solid white', margin: "1em"}}>
            <p style={{color: "white", padding: "1em", display: "flex", flexDirection: "column", alignItems: "center"}}>
                ...
                <span style={{marginLeft: "10px"}}>Tech Stack: Jikan API, React, Node, Express, Cors, Redux, Nodemailer, dotenv, CSS and HTML; logo created by developer using: <a href="https://partner.canva.com/c/2099558/653599/10068" target="_blank">Canva</a></span></p>
